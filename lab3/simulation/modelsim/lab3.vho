...
-- Equation(s):
-- \inst7~0_combout\ = ( \a~input_o\ & ( !\Cin~input_o\ $ (\b~input_o\) ) ) # ( !\a~input_o\ & ( !\Cin~input_o\ $ (!\b~input_o\) ) )
...
-- Equation(s):
-- \inst6~0_combout\ = ( \a~input_o\ & ( (\Cin~input_o\) # (\b~input_o\) ) ) # ( !\a~input_o\ & ( (\b~input_o\ & \Cin~input_o\) ) )
