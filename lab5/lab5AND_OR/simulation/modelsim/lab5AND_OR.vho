...
-- P	=>  Location: PIN_V10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A	=>  Location: PIN_AA7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF lab5AND_OR IS
...
-- Equation(s):
-- \inst5~0_combout\ = ( \S2~input_o\ & ( \S0~input_o\ ) ) # ( !\S2~input_o\ & ( \S1~input_o\ ) )
...
-- Equation(s):
-- \inst4~0_combout\ = ( \S2~input_o\ & ( \S1~input_o\ ) ) # ( !\S2~input_o\ & ( \S0~input_o\ ) )
